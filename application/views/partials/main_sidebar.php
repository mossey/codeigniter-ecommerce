        ...
        <div class="category-products">
            <?php foreach ($categories as $category) { ?>
                <?php if (!empty($category->products)) { ?>
                    <a href="<?php echo site_url('categorie/' . url_title($category->{'name_'.$language}) . '-' . $category->id); ?>" class="cp-category <?php echo (!empty($main_category) && $main_category->id == $category->id) ? 'active' : ''; ?>">
